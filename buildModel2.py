...
"""
This model is buildModel2, for example: building a pizza.
name:
dough
sauce
topping tings
...
class Pizza:
    def __init__(self, name) -> 'init pizza':
        self.name = name
        self.dough = None
        self.sauce = None
        self.topping = []
    ...
    def prepare_dough(self, dough) -> 'dough':
        self.dough = dough
...
class MargaritaBuilder:
    ...
    def add_topping(self):
        ...
        self.pizza.topping.append([t for t in (
            ...
            PizzaTopping.ham, PizzaTopping.red_onion, PizzaTopping.oregano)])
        time.sleep(STEP_DELAY)
        print('done with the topping (mozzare, bacon, ham, red onion, oregano)')
